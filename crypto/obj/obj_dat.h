...
static const ASN1_OBJECT kObjects[NUM_NID] = {
    ...
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"SM4-ECB", "sm4-ecb", NID_sm4_ecb, 8, &kObjectData[6196], 0},
    {"SM4-CBC", "sm4-cbc", NID_sm4_cbc, 8, &kObjectData[6204], 0},
    {"SM4-OFB", "sm4-ofb", NID_sm4_ofb128, 8, &kObjectData[6212], 0},
    {"SM4-CFB1", "sm4-cfb1", NID_sm4_cfb1, 8, &kObjectData[6220], 0},
    {"SM4-CFB", "sm4-cfb", NID_sm4_cfb128, 8, &kObjectData[6228], 0},
    {"SM4-CFB8", "sm4-cfb8", NID_sm4_cfb8, 8, &kObjectData[6236], 0},
    {"SM4-CTR", "sm4-ctr", NID_sm4_ctr, 8, &kObjectData[6244], 0},
    {"ISO-CN", "ISO CN Member Body", NID_ISO_CN, 3, &kObjectData[6252], 0},
    {"oscca", "oscca", NID_oscca, 5, &kObjectData[6255], 0},
    {"sm-scheme", "sm-scheme", NID_sm_scheme, 6, &kObjectData[6260], 0},
    {"SM3", "sm3", NID_sm3, 8, &kObjectData[6266], 0},
    {"RSA-SM3", "sm3WithRSAEncryption", NID_sm3WithRSAEncryption, 8,
     &kObjectData[6274], 0},
    {"SM2", "sm2", NID_sm2, 8, &kObjectData[6282], 0},
    {"SM2-SM3", "SM2-with-SM3", NID_SM2_with_SM3, 8, &kObjectData[6290], 0},
    {"SM4-GCM", "sm4-gcm", NID_sm4_gcm, 8, &kObjectData[6298], 0},
    {"SM4-CCM", "sm4-ccm", NID_sm4_ccm, 8, &kObjectData[6306], 0},
    {"hmacWithSM3", "hmacWithSM3", NID_hmacWithSM3, 10, &kObjectData[6314], 0},
    {NULL, NULL, NID_undef, 0, NULL, 0},
    {"id-ecSigType", "id-ecSigType", NID_X9_62_id_ecSigType, 6,
     &kObjectData[6324], 0},
    {"PBE-SM3-SMS4", "pbeWithSM3AndSMS4-CBC", NID_pbe_WithSM3AndSMS4_CBC, 10,
     &kObjectData[6330], 0},
    {"secg-scheme", "secg-scheme", NID_secg_scheme, 4, &kObjectData[6340], 0},
    {"ZUC", "zuc", NID_zuc, 8, &kObjectData[6344], 0},
    {"ZUC-128-EEA3", "zuc-128-eea3", NID_zuc_128_eea3, 8, &kObjectData[6352],
     0},
    {"ZUC-128-EIA3", "zuc-128-eia3", NID_zuc_128_eia3, 8, &kObjectData[6360],
     0},
...
static const uint16_t kNIDsInOIDOrder[] = {
    ...
    976 /* 1.2.156.10197.1 (OBJ_sm_scheme) */,
    ...
    985 /* 1.2.840.10045.4 (OBJ_X9_62_id_ecSigType) */,
    ...
    967 /* 1.2.156.10197.1.104.1 (OBJ_sm4_ecb) */,
    968 /* 1.2.156.10197.1.104.2 (OBJ_sm4_cbc) */,
    969 /* 1.2.156.10197.1.104.3 (OBJ_sm4_ofb128) */,
    971 /* 1.2.156.10197.1.104.4 (OBJ_sm4_cfb128) */,
    970 /* 1.2.156.10197.1.104.5 (OBJ_sm4_cfb1) */,
    972 /* 1.2.156.10197.1.104.6 (OBJ_sm4_cfb8) */,
    973 /* 1.2.156.10197.1.104.7 (OBJ_sm4_ctr) */,
    981 /* 1.2.156.10197.1.104.8 (OBJ_sm4_gcm) */,
    982 /* 1.2.156.10197.1.104.9 (OBJ_sm4_ccm) */,
    988 /* 1.2.156.10197.1.201 (OBJ_zuc) */,
    979 /* 1.2.156.10197.1.301 (OBJ_sm2) */,
    977 /* 1.2.156.10197.1.401 (OBJ_sm3) */,
    980 /* 1.2.156.10197.1.501 (OBJ_SM2_with_SM3) */,
    978 /* 1.2.156.10197.1.504 (OBJ_sm3WithRSAEncryption) */,
    989 /* 1.2.156.10197.1.801 (OBJ_zuc_128_eea3) */,
    990 /* 1.2.156.10197.1.802 (OBJ_zuc_128_eia3) */,
    ...
    983 /* 1.2.156.10197.1.401.3.1 (OBJ_hmacWithSM3) */,
    ...
    986 /* 1.2.840.113549.1.12.1.100 (OBJ_pbe_WithSM3AndSMS4_CBC) */,
