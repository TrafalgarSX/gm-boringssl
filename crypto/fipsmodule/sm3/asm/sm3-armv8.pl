...
my $constaddr="x8";
# void sm3_block_data_order_hw(SM3_CTX *c, const void *p, size_t num)
$code.=<<___;
.globl	sm3_block_data_order_hw
.type	sm3_block_data_order_hw,%function
.align	5
sm3_block_data_order_hw:
	// load state
...
$code.=<<___;
	...
	ret
.size	sm3_block_data_order_hw,.-sm3_block_data_order_hw
